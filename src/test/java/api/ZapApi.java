...
public class ZapApi
{
     ...
     * @param apiKeyZap la cle d acces a l API. Pour l'instance centralisee celle ci est a valoriser a null
    ...
    public static String runSpider(String baseUrl, int portZap, String adressZap, String apiKeyZap)
    {
        ...
        {
            LOGGER_ZAP.atWarning().withCause(e).withStackTrace(StackSize.FULL)
    ...
    /**
     * M�thode static pour lancer le scan de zap pre etape au scan de detection de vulnerabilites
     * 
     * @param baseUrl   url de l application
     * @param adressZap adresse de l instance du demon zap
     * @param portZap   port d ecoute de Zap en mode proxy
